window.addEventListener("load", function() {
	...
	class SoundEffect {
		constructor(type) {
			this.exp = 'assets/SoundPack/Fire impact.wav';
			this.heal = 'assets/SoundPack/Healing.wav';
			this.shoot = 'assets/SoundPack/shoot.wav';
			this.sound = new Audio();
			this.sound.src = type === "exp" ? this.exp : type === "heal" ? this.heal : this.shoot;
		}
		play() {
			this.sound.play();
			setTimeout(delete(this), 3000);
		}
	}
	...
	class Game {
		...
		update(deltaTime) {
			...
			this.explosions.filter(exp => !exp.markedForDeletion);
